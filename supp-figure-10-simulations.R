...
# -- Save Supp figure 10a
ggsave("figs/supp-figure-10a.pdf",
       plot   = supp_fig10a,
       dpi    = 300, 
       height = 5,
       width  = 7)
...
# -- Save Supp figure 10b
ggsave("figs/supp-figure-10b.pdf",
       plot   = supp_fig10b,
       dpi    = 300, 
       height = 5,
       width  = 7)
...
# -- Save Supp figure 9c
ggsave("figs/supp-figure-10c.pdf",
       plot   = supp_fig10c,
       dpi    = 300, 
       height = 5,
       width  = 7)
...
# -- Save Supp figure 10d
ggsave("figs/supp-figure-10d.pdf",
       plot   = supp_fig10d,
       dpi    = 300, 
       height = 5,
       width  = 7)
...
# -- Save Supp figure 9e
ggsave("figs/supp-figure-10e.pdf",
       plot   = supp_fig10e,
       dpi    = 300, 
       height = 5,
       width  = 7)
...
# -- Save Supp figure 10f
ggsave("figs/supp-figure-10f.pdf",
       plot   = supp_fig10f,
       dpi    = 300, 
       height = 5,
       width  = 7)
### -- ------------------------------------ ------------------------------------------------------------------------
### -- END Supp figure 10: Simulation study ------------------------------------------------------------------------
### -- ------------------------------------ ------------------------------------------------------------------------