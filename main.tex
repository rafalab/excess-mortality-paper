...
The Cook County medical examiner is providing daily updates of their death record, which includes demographic information, such as age and race, about each individual. Although not all deaths that occur in the county fall under the jurisdiction of the medical examiner, disease constituting a threat to public health, are included [CITE https://www.cookcountyil.gov/agency/medical-examiner]. Since our model provides both estimates and standard errors of event effect, we can compare the effects for two or more groups and assess the statistical significance of the observed differences. Using these data, we note that largest percent increases observed for individuals over 65 \textbf{(Supp Fig X)}. Among those 65 years of age and older, the increase in medical examiner death rate for Cook county was as high as \textbf{XXX} on \textbf{XXXX} and shows a significant difference between black and white populations. The population size for other racial groups of this age was substantially smaller and were not included in the analysis.
