...
we note that the results of our analysis would change if different population sizes $N_t$ were used and that these sizes are themselves estimates produced by government agencies. Third, 
...
Here we provide further details of our model and estimation approach. Further, we show that our model can also be apply to weekly data, show the calculations behind our excess death estimates, and conclude with a simulation study to validate our approach. 
...
\begin{suppfigure}[ht]
    ...
    \caption{Estimated event effects as percent increase over expected mortality. The solid line corresponds to percent change from expected mortality, the shaded region represents a 95\% confidence interval, and points show observed percent change from expected mortality. A) Percent change during the Chikungunya epidemic in Puerto Rico for six age groups. B) Percent change during the 2005 flu season in Puerto Rico.}
